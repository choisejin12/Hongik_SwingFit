...
import { UserContext, ProgressContext,StartContext ,LoadingContext} from '../contexts';
import Main from './Main';
import { Spinner,Loading } from '../components';
...
const Navigation = () => {
    ...
    const {inTest} = useContext(LoadingContext);
